...
#define RLOG_WIDE_STRINGS

#ifdef RLOG_WIDE_STRINGS
#define RLOG_CHAR_T wchar_t
#define RLOG_VPRINTF _vsnwprintf_s
#else
#define RLOG_CHAR_T char
#define RLOG_VPRINTF vsnprintf_s
#endif
...
*/
	...
	#error RLOG_COMPONENT not defined - setting to UNKNOWN
