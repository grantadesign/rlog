...
#define RLOG_CHANNEL_IMPL(COMPONENT,path,level) \
    ...
    */
    ...
    extern RLOG_DECL RLogChannel *_RLIWAChannel;
    extern RLOG_DECL RLogChannel *_RLSyncChannel;
    ...
    */
	...
	void (*publish)(PublishLoc *, RLogChannel *, const RLOG_CHAR_T *format, ... )
	    PRINTF_FP(3,4);
	RLogNode *pub;
    ...
    void RLOG_DECL RLog_Register(PublishLoc *loc, RLogChannel *, 
	               const RLOG_CHAR_T *format, ... ) PRINTF(3,4);
